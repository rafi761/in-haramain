        ...
        <div className="grid grid-cols-1 gap-x-12 md:grid-cols-2 xl:grid-cols-3 gap-y-8">
            <Card className="py-4 w-fit mx-auto" data-aos="zoom-in-down">
                ...
                <CardBody className="pb-0 pt-2 px-4 flex-col items-start">
                    ...
                    <h4 className="font-bold text-large">UMROH REGULER 9 HARI <span className="text-lg text-black font-normal">/ Rp. 27.900.000</span></h4>
                    ...
                    <div className="flex flex-col gap-y-4 mt-3">
                        ...
                        <Link href="/paket1" className="px-3 py-2 bg-[#EAC100] rounded-lg text-white w-fit">
                            Detail Paket
                        </Link>
                    </div>
                </CardBody>
            ...
            <Card className="py-4 w-fit mx-auto" data-aos="zoom-in-up">
                ...
                <CardBody className="pb-0 pt-2 px-4 flex-col items-start">
                    <p className="text-tiny uppercase font-bold">Program 12 Hari</p>
                    <small className="text-default-500">Agustus - September 2024</small>
                    <h4 className="font-bold text-large">UMROH PLUS TURKI <span className="text-lg text-black font-normal">/ Rp. 28.000.000</span></h4>
                    ...
                    <div className="flex flex-col gap-y-4 mt-3">
                        ...
                        <div className="grid grid-cols-2">
                            ...
                            <div className="flex items-center gap-x-1 ml-[-40px]">
                                <IoIosCheckmarkCircleOutline size={35} className="text-[#0B8457] max-sm:w-7" />
                                <p className="text-black text-base max-md:text-sm">Paspor</p>
                            </div>
                            <div className="flex items-center gap-x-1">
                                <IoIosCheckmarkCircleOutline size={35} className="text-[#0B8457] max-sm:w-7" />
                                <p className="text-black text-base max-md:text-sm">Asuransi</p>
                            ...
                            <div className="flex items-center gap-x-1 ml-[-40px]">
                                <IoIosCheckmarkCircleOutline size={35} className="text-[#0B8457] max-sm:w-7" />
                                <p className="text-black text-base max-md:text-sm">Tips Guide Turki</p>
                            </div>
                            <div className="flex items-center gap-x-1">
                                <IoIosCheckmarkCircleOutline size={35} className="text-[#0B8457] max-sm:w-7" />
                                <p className="text-black text-base max-md:text-sm">dll</p>
                        ...
                        <Link href="/paket3" className="px-3 py-2 bg-[#EAC100] rounded-lg text-white w-fit">
                            Detail Paket
                        </Link>
                    </div>
                </CardBody>
