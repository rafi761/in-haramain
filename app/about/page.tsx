    ...
    return (
        <section className="w-full h-fit bg-[#EEEDEB] px-36 py-20 grid grid-cols-2 max-lg:grid-cols-1 max-lg:px-8 max-lg:gap-y-5">
            ...
            <div className="flex flex-col gap-y-3 justify-center">
                <h1 className="text-black text-3xl font-semibold max-md:text-2xl">Profil singkat Travel Umroh <br className="lg:hidden" /> In - Haramain Tour
                </h1>
                <p className="text-black text-base">Travel Umroh In-Haramain tour merupakan nama Branding biro Umroh dari PT Internasional Haramain Makkah yang telah memiliki izin dari kementerian agama Indonesia <br className="max-xs:hidden" /> dengan <span className="text-black font-semibold">No PPIU : 2071220059084003</span></p>
